        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Laundry Admin <sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="create-customer.php">Create Customer</a>
                        <a class="collapse-item" href="all-customers.php">All Customers</a>
                        <a class="collapse-item" href="print-customers.php">Generate Report</a>
                    </div>
                </div>
            </li>
